...
kable_styling(kable(head(atlasambiental, 5)), bootstrap_options = "striped", 
              full_width = T, 
              font_size = 12)
...
# Eu sou novato em R e faz alguns anos que trabalhei com Python (Estou meio enferrujado), 
# mas  Sobre o %>% eu entendi é uma outra forma de fazer uma chamada de função:
# Ex.: 
head(atlasambiental, 5)  
# é equivalente a:
atlasambiental %>% head(5)

# O pipe coloca a expressão "atlasambiental" como primeiro prametro da função "head"

# Essa construção do PIPE tem uma cara de programação funcional usado em scala e  kotlin
